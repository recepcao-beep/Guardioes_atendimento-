...
export default function InvitesListView({
  user, sectors, platforms, invites, onInviteCreated
        ...
        <div className="block md:hidden space-y-3">
          {activeFilteredList.length === 0 ? (
            ...
            activeFilteredList.map((row) => {
              ...
              return (
                <div key={row.id} className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-150 dark:border-slate-805 dark:border-slate-800 shadow-sm space-y-2.5 text-slate-800 dark:text-slate-100">
                  ...
                  <div className="text-xs font-mono text-slate-500 flex justify-between py-1 border-t border-slate-50 text-[11px]">
                    <div>
                    ...
                    <div className="text-right">
                      <span className="block text-[9px] text-slate-400">Hóspede</span>
                      <strong>{row.guest_phone_masked || '-'}</strong>
                    </div>
                  </div>

                  <div className="flex justify-between items-center text-[10.5px] border-t border-slate-50 pt-2">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-slate-100 text-slate-400 text-[10px] font-bold uppercase tracking-wider">
                ...
                <th className="py-3 px-4">Hóspede (WhatsApp)</th>
                  ...
                  return (
                    <tr key={row.id} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="py-3.5 px-4">
                        <span className="capitalize font-mono text-[10px] bg-slate-100 text-slate-600 px-1.5 py-0.5 rounded">
